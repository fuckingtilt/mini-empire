...
function Game() {
  ...
  useEffect(() => {
    const saved = localStorage.getItem("mini-empire-save-v6");
  ...
  const resetProgress = () => {
    localStorage.removeItem("mini-empire-save-v6");
      ...
      {tab === "shop" && (
        <div className="bg-zinc-900 p-5 rounded-2xl w-80 shadow-2xl">
          ...
          <p className="mt-4 text-xs text-zinc-500">
            Payments currently use TON Connect on frontend. Backend verification is the next step.
          </p>
        </div>
      )}
